...
import 'package:fbus_app_driver/src/pages/driver/dashboard/loadMore/load_more_controller.dart';
...
class _LoadMorePageState extends State<LoadMorePage> {
  LoadMoreController con = Get.put(LoadMoreController());
  FlutterSecureStorage storage = const FlutterSecureStorage();
  double screenWidth = 0;
  bool listIsEmpty = false;
  bool _isFirstLoadRunning = false;
  List<TripModel> _listTripMore = [];
                          ...
                          ? Expanded(
                              child: Container(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemCount: _listTripMore.length,
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      _listTripMore[index].departure,
                                      style: const TextStyle(
                                          fontSize: 15,
                                          fontWeight: FontWeight.w500),
                                    ),
                                    Text(
                                      _listTripMore[index].destination,
                                      style: const TextStyle(
                                          fontSize: 15,
                                          fontWeight: FontWeight.w500),
                                    ),
                      ...
                      child: Row(
                        ...
                        children: [
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Text(
                                    _listTripMore[index].departureTime,
                                    style: TextStyle(
                                        fontSize: 16,
                                        fontWeight: FontWeight.w500),
                                  ),
                          ...
                          Container(
                            ...
                            child: Text(
                              _listTripMore[index].ticketQuantity.toString(),
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 22,
                                fontWeight: FontWeight.w500,
