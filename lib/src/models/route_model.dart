...
import 'package:fbus_app_driver/src/models/station_model.dart';
...
class RouteModel {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "departure_coordinates":
            List<dynamic>.from(departureCoordinates.map((x) => x.toJson())),
        "destination": destination,
        "destination_coordinates":
            List<dynamic>.from(destinationCoordinates.map((x) => x.toJson())),
        "status": status,
